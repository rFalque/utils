...
namespace igl
{
  template <typename T, typename Derived> inline bool list_to_matrix(const std::vector<std::vector<T > > & V,Eigen::PlainObjectBase<Derived>& M);
  template <typename T, typename Derived> inline bool list_to_matrix(const std::vector<std::vector<T > > & V, const int n, const T & padding, Eigen::PlainObjectBase<Derived>& M);
  template <typename T, typename Derived> inline bool list_to_matrix(const std::vector<T > & V,Eigen::PlainObjectBase<Derived>& M);
